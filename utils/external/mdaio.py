# this is code is taken from mountainlab_pytools @ https://github.com/magland/mountainlab_pytools/tree/master/mountainlab_pytools/mdaio
# its inclusion here is simply for convenience as the whole of mountainlab_pytools only works with python=3.6
